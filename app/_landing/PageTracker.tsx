...
// Pageview + scroll tracking for one route. Mounted once by each top-level
...
export function PageTracker({ page }: { page: string }) {
  ...
  // (every locale home is "Home", every blog article is "Blog article"), and
  // a `page`-only dependency would skip the second pageview and leave the
  // scroll listener measuring the unmounted route.
