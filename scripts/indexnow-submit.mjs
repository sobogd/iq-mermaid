...
const SITE_URL = (process.env.SITE_URL ?? "https://iq-mermaid.com").replace(/\/$/, "");
...
export function pathsForFile(file) {
  ...
  // A new or removed article changes every locale's blog index.
  if (file === "content/blog/manifest.json") return null;
